...
(function(tinymce) {
	...
	tinymce.create('tinymce.plugins.AutoSave', {
		...
		init : function(ed, url) {
			var self = this, configurations = ed.configurations;
			...
			// Parse times
			configurations.autosave_interval = parseTime(configurations.autosave_interval);
			configurations.autosave_retention = parseTime(configurations.autosave_retention);
			...
			ed.onInit.add(function() {
				...
				if (ed.controlManager.get(RESTORE_DRAFT)) {
					...
					setInterval(function() {
						self.storeDraft();
						ed.nodeChanged();
					}, configurations.autosave_interval);
				}
			});
		...
		getExpDate : function() {
			return new Date(
				new Date().getTime() + this.editor.configurations.autosave_retention
			).toUTCString();
		},
		...
		storeDraft : function() {
			...
			if (storage) {
				...
				if (content.length > editor.configurations.autosave_minlength) {
